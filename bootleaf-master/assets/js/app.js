...
map = L.map("map", {
  zoom: 14,
  center: [-89.5925860,20.9673700], // se le cambio las coordenadas que tenia anteriormente y se le coloca la merida
...
var baseLayers = {
 ...
 /*"Aerial Imagery": mapquestOAM,
  "Imagery with Streets": mapquestHYB*/  /* se coloco como comentario para dejar una opcion del mapa*/
};

var groupedOverlays = {
  "Points of Interest": {
    "<img src='assets/img/theater.png' width='24' height='28'>&nbsp;Restaurantes": theaterLayer,/*se le cambio el nombre */
    "<img src='assets/img/museum.png' width='24' height='28'>&nbsp;Hoteles": museumLayer /*se le cambio el nombre */
  },
  "Reference": {
    "Boroughs": boroughs,
    /*"Subway Lines": subwayLines*/  /* se elimino esta opcion para se muestre solamente una*/
  }
};
